...
public class Application {
  ...
  private final String COMMAND_FINGERPRINT_AUTHENTICATE = "mobile:fingerprint:set";
	...
	/**
	 * Install application. Its path and id must be set prior to calling this method.
	...
	/**
	 * Uninstalls an application. Its id or name must be set prior to calling this method
	 * The function will automatically use the app id or app name (if id is not found)
	 * @return
	 */
	...
	/**
	 * Open an app. App id or name must be set prior to calling this method. 
	 * If id is not set, name will be used for starting the app. 
	 * If none of them are provided, false will be returned
	 * @return true on successful execution of the function
	 */
	public Boolean Open() 
	{
	...
	/**
	 * Opens app by provided identifier. The identifier could be an the app id (appPackage or bundleId) or its name.
	 * The function will try to open app by id first and if it fails, it will try to open the app by name.
	 * @param identifier
	 * @return
	 */
	...
	/**
	 * Close a running app. App id or name must be provided prior to calling this method.
	 * @return
	 */
	...
	/**
	 * Close app by provided id or name. First try to close the app by id and then by name.
	 * @param identifier
	 * @return
	 */
	...
	/**
	 * Close app by id
	 * @param id the bundleID or appPackage
	 * @return
	 */
	...
	/**
	 * Start image injection for the current app. App id or name must be provided prior to calling this function. 
	 * Uses ID or name.
	 * @param repositoryFile - path to the image in the repository to be injected
	 * @return
	 */
	...
	{
		if (!context.equalsIgnoreCase(CONTEXT_WEB) && !context.equalsIgnoreCase(CONTEXT_NATIVE) && !context.equalsIgnoreCase(CONTEXT_VISUAL))
		{
